const SETTINGS_KEY = "six-the-musical-display-settings";
const CURRENT_SONG_KEY = "six-the-musical-current-song";
const SIDEBAR_KEY = "six-the-musical-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "six-the-musical-playback-rate";
