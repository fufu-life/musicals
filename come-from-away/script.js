const SETTINGS_KEY = "come-from-away-display-settings";
const CURRENT_SONG_KEY = "come-from-away-current-song";
const SIDEBAR_KEY = "come-from-away-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "come-from-away-playback-rate";
