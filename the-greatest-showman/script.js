const SETTINGS_KEY = "the-greatest-showman-display-settings";
const CURRENT_SONG_KEY = "the-greatest-showman-current-song";
const SIDEBAR_KEY = "the-greatest-showman-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "the-greatest-showman-playback-rate";
