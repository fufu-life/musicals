const SETTINGS_KEY = "chicago-display-settings";
const CURRENT_SONG_KEY = "chicago-current-song";
const SIDEBAR_KEY = "chicago-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "chicago-playback-rate";
