const SETTINGS_KEY = "don-juan-display-settings";
const CURRENT_SONG_KEY = "don-juan-current-song";
const SIDEBAR_KEY = "don-juan-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "don-juan-playback-rate";
