const SETTINGS_KEY = "matilda-display-settings";
const CURRENT_SONG_KEY = "matilda-current-song";
const SIDEBAR_KEY = "matilda-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "matilda-playback-rate";
