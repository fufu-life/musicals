const SETTINGS_KEY = "notre-dame-de-paris-display-settings";
const CURRENT_SONG_KEY = "notre-dame-de-paris-current-song";
const SIDEBAR_KEY = "notre-dame-de-paris-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "notre-dame-de-paris-playback-rate";
