const SETTINGS_KEY = "suffs-display-settings";
const CURRENT_SONG_KEY = "suffs-current-song";
const SIDEBAR_KEY = "suffs-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "suffs-playback-rate";
