const SETTINGS_KEY = "romeo-et-juliette-display-settings";
const CURRENT_SONG_KEY = "romeo-et-juliette-current-song";
const SIDEBAR_KEY = "romeo-et-juliette-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "romeo-et-juliette-playback-rate";
