const SETTINGS_KEY = "dear-evan-hansen-display-settings";
const CURRENT_SONG_KEY = "dear-evan-hansen-current-song";
const SIDEBAR_KEY = "dear-evan-hansen-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "dear-evan-hansen-playback-rate";
