const SETTINGS_KEY = "cyrano-de-bergerac-display-settings";
const CURRENT_SONG_KEY = "cyrano-de-bergerac-current-song";
const SIDEBAR_KEY = "cyrano-de-bergerac-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "cyrano-de-bergerac-playback-rate";
