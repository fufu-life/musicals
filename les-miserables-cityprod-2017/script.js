const SETTINGS_KEY = "les-miserables-cityprod-2017-display-settings";
const CURRENT_SONG_KEY = "les-miserables-cityprod-2017-current-song";
const SIDEBAR_KEY = "les-miserables-cityprod-2017-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "les-miserables-cityprod-2017-playback-rate";
