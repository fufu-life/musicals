const SETTINGS_KEY = "legally-blonde-display-settings";
const CURRENT_SONG_KEY = "legally-blonde-current-song";
const SIDEBAR_KEY = "legally-blonde-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "legally-blonde-playback-rate";
