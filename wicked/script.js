const SETTINGS_KEY = "wicked-display-settings";
const CURRENT_SONG_KEY = "wicked-current-song";
const SIDEBAR_KEY = "wicked-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "wicked-playback-rate";
