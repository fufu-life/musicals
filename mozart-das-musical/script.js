const SETTINGS_KEY = "mozart-das-musical-display-settings";
const CURRENT_SONG_KEY = "mozart-das-musical-current-song";
const SIDEBAR_KEY = "mozart-das-musical-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "mozart-das-musical-playback-rate";
