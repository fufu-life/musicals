const SETTINGS_KEY = "dracula-das-musical-display-settings";
const CURRENT_SONG_KEY = "dracula-das-musical-current-song";
const SIDEBAR_KEY = "dracula-das-musical-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "dracula-das-musical-playback-rate";
