const SETTINGS_KEY = "les-miserables-display-settings";
const CURRENT_SONG_KEY = "les-miserables-current-song";
const SIDEBAR_KEY = "les-miserables-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "les-miserables-playback-rate";
