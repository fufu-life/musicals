const SETTINGS_KEY = "rebecca-das-musical-display-settings";
const CURRENT_SONG_KEY = "rebecca-das-musical-current-song";
const SIDEBAR_KEY = "rebecca-das-musical-sidebar-collapsed";
