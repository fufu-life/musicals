const SETTINGS_KEY = "le-petit-prince-2cd-display-settings";
const CURRENT_SONG_KEY = "le-petit-prince-2cd-current-song";
const SIDEBAR_KEY = "le-petit-prince-2cd-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "le-petit-prince-2cd-playback-rate";
