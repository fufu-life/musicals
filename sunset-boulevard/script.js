const SETTINGS_KEY = "sunset-boulevard-display-settings";
const CURRENT_SONG_KEY = "sunset-boulevard-current-song";
const SIDEBAR_KEY = "sunset-boulevard-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "sunset-boulevard-playback-rate";
