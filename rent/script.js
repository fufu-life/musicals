const SETTINGS_KEY = "rent-display-settings";
const CURRENT_SONG_KEY = "rent-current-song";
const SIDEBAR_KEY = "rent-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "rent-playback-rate";
