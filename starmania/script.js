const SETTINGS_KEY = "starmania-display-settings";
const CURRENT_SONG_KEY = "starmania-current-song";
const SIDEBAR_KEY = "starmania-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "starmania-playback-rate";
