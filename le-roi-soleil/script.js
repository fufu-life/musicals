const SETTINGS_KEY = "le-roi-soleil-display-settings";
const CURRENT_SONG_KEY = "le-roi-soleil-current-song";
const SIDEBAR_KEY = "le-roi-soleil-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "le-roi-soleil-playback-rate";
