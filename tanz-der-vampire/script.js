const SETTINGS_KEY = "tanz-der-vampire-display-settings";
const CURRENT_SONG_KEY = "tanz-der-vampire-current-song";
const SIDEBAR_KEY = "tanz-der-vampire-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "tanz-der-vampire-playback-rate";
