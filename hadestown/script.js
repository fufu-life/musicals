const SETTINGS_KEY = "hadestown-display-settings";
const CURRENT_SONG_KEY = "hadestown-current-song";
const SIDEBAR_KEY = "hadestown-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "hadestown-playback-rate";
