const SETTINGS_KEY = "tick-tick-boom-display-settings";
const CURRENT_SONG_KEY = "tick-tick-boom-current-song";
const SIDEBAR_KEY = "tick-tick-boom-sidebar-collapsed";
