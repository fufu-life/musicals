const SETTINGS_KEY = "love-never-dies-display-settings";
const CURRENT_SONG_KEY = "love-never-dies-current-song";
const SIDEBAR_KEY = "love-never-dies-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "love-never-dies-playback-rate";
