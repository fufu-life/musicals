const SETTINGS_KEY = "moulin-rouge-display-settings";
const CURRENT_SONG_KEY = "moulin-rouge-current-song";
const SIDEBAR_KEY = "moulin-rouge-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "moulin-rouge-playback-rate";
