const SETTINGS_KEY = "les-dix-commandements-display-settings";
const CURRENT_SONG_KEY = "les-dix-commandements-current-song";
const SIDEBAR_KEY = "les-dix-commandements-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "les-dix-commandements-playback-rate";
