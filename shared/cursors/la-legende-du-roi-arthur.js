...
(() => {
  ...
  const config = {"motif":"excalibur","trail":"magicDust","burst":"crispShockwave","motion":"still","accent":"#d5b85d","size":72,"follow":0.68,"emitDistance":14,"clickOn":"down","burstParticles":3,"hotspot":[0,0],"primary":"#65793b","secondary":"#d7bb67"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
