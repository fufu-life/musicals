(() => {
  ...
  const config = {"motif":"comeFromAwayGlobe","trail":"none","burst":"none","motion":"still","accent":"#2d9fb6","size":50,"follow":0.46,"emitDistance":1000000000,"clickOn":"none","burstParticles":0,"hotspot":[0.5,0.5],"primary":"#2d9fb6","secondary":"#e3bd58"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
  ...
  function preRenderComeFromAwayGlobe() {
  ...
  preRenderComeFromAwayGlobe();
  if (config.motif === "comeFromAwayGlobe") {
    new MutationObserver(() => preRenderComeFromAwayGlobe()).observe(document.documentElement, {
      attributes: true,
