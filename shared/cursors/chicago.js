(() => {
  ...
  const config = {"motif":"chicagoNewspaper","trail":"none","burst":"headlineDrop","motion":"still","accent":"#c51f2b","size":58,"follow":0.58,"emitDistance":1000000000,"clickOn":"up","burstParticles":0,"hotspot":[0.5,0.5],"primary":"#c51f2b","secondary":"#f3d39a"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
  ...
  function preRenderChicagoNewspaper() {
  ...
  preRenderChicagoNewspaper();
  if (config.motif === "comeFromAwayGlobe") {
    new MutationObserver(() => preRenderChicagoNewspaper()).observe(document.documentElement, {
      attributes: true,
