...
(() => {
  ...
  const config = {"motif":"bowlerHat","trail":"goldSparkleRosePetal","burst":"spectacular","motion":"tilt","accent":"#c51f2b","size":58,"follow":0.48,"emitDistance":20,"clickOn":"up","burstParticles":6,"hotspot":[0.5,0.5],"primary":"#c51f2b","secondary":"#f3d39a"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
