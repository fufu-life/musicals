(() => {
  ...
  const config = {"motif":"soundOfMusicNote","trail":"none","burst":"softDiamondGlow","motion":"still","accent":"#4fb6d7","size":60,"follow":1,"emitDistance":1000000000,"clickOn":"down","burstParticles":0,"hotspot":[0.5,0.5],"primary":"#4fb6d7","secondary":"#cfeff7"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
  ...
  function preRenderSoundOfMusicNote() {
  ...
  preRenderSoundOfMusicNote();
  if (config.motif === "comeFromAwayGlobe") {
    new MutationObserver(() => preRenderSoundOfMusicNote()).observe(document.documentElement, {
      attributes: true,
