(() => {
  ...
  const config = {"motif":"legallyBlondeBalance","trail":"none","burst":"subtleRing","motion":"still","accent":"#d72d78","size":48,"follow":0.52,"emitDistance":1000000000,"clickOn":"down","burstParticles":0,"hotspot":[0.5,0.5],"primary":"#d72d78","secondary":"#f3c4d8"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
  ...
  function preRenderLegallyBlondeBalance() {
  ...
  preRenderLegallyBlondeBalance();
  if (config.motif === "comeFromAwayGlobe" || config.motif === "legallyBlondeBalance") {
    new MutationObserver(() => preRenderLegallyBlondeBalance()).observe(document.documentElement, {
      attributes: true,
