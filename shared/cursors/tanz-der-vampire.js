(() => {
  ...
  const config = {"motif":"vampireBat","trail":"none","burst":"subtleRing","motion":"still","accent":"#b51e3d","size":58,"follow":0.58,"emitDistance":1000000000,"clickOn":"down","burstParticles":0,"hotspot":[0.5,0.5],"primary":"#a32643","secondary":"#d8b56d"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
