(() => {
  ...
  const config = {"motif":"passionCrossHalo","trail":"none","burst":"subtleRing","motion":"still","accent":"#d6b46a","size":56,"follow":0.5,"emitDistance":18,"clickOn":"down","burstParticles":0,"hotspot":[0.5,0.5],"primary":"#d5a23c","secondary":"#efe1b1"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
