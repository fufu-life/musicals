(() => {
  ...
  const config = {"motif":"filmReel","trail":"none","burst":"none","motion":"turn","accent":"#d78024","size":60,"follow":0.58,"emitDistance":1000000000,"clickOn":"none","burstParticles":0,"hotspot":[0.5,0.5],"primary":"#d78024","secondary":"#f1d7a2"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
