...
(() => {
  ...
  const config = {"motif":"filmReel","trail":"goldSparkleRosePetal","burst":"lunarBloom","motion":"turn","accent":"#d78024","size":60,"follow":0.42,"emitDistance":19,"clickOn":"down","burstParticles":3,"hotspot":[0.5,0.5],"primary":"#d78024","secondary":"#f1d7a2"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
