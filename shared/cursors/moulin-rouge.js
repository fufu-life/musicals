(() => {
  ...
  const config = {"motif":"windmill","trail":"goldSparkleRosePetal","burst":"spectacular","motion":"turn","accent":"#e21d2a","size":62,"follow":0.45,"emitDistance":25,"clickOn":"up","burstParticles":9,"hotspot":[0.5,0.5],"primary":"#d5233f","secondary":"#f4c76f"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
  ...
  function preRenderMoulinWindmill() {
  ...
  preRenderMoulinWindmill();
  if (config.motif === "comeFromAwayGlobe") {
    new MutationObserver(() => preRenderMoulinWindmill()).observe(document.documentElement, {
      attributes: true,
