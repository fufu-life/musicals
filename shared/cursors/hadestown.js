(() => {
  ...
  const config = {"motif":"hadestownFlower","trail":"thornEmbers","burst":"none","motion":"still","accent":"#b33a2c","size":62,"follow":0.46,"emitDistance":18,"clickOn":"none","burstParticles":0,"hotspot":[0.5,0.5],"primary":"#b33a2c","secondary":"#e9d3a0"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
  ...
  function preRenderHadestownFlower() {
  ...
  preRenderHadestownFlower();
  if (config.motif === "comeFromAwayGlobe") {
    new MutationObserver(() => preRenderHadestownFlower()).observe(document.documentElement, {
      attributes: true,
