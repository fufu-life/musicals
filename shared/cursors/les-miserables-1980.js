...
(() => {
  ...
  const config = {"motif":"revolutionFlag","trail":"magicDust","burst":"crispShockwave","motion":"still","accent":"#e6c472","size":54,"follow":0.52,"emitDistance":16,"clickOn":"down","burstParticles":4,"hotspot":[0.24,0.54],"primary":"#b33a35","secondary":"#e6c472"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
