...
(() => {
  ...
  const config = {"motif":"posterMoon","trail":"moonMist","burst":"lunarBloom","motion":"still","accent":"#e21b38","size":64,"follow":0.45,"emitDistance":16,"clickOn":"down","burstParticles":0,"hotspot":[0.5,0.5],"primary":"#b51f2e","secondary":"#f0d8c6"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
