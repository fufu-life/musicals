...
(() => {
  ...
  const config = {"motif":"concertFlag","trail":"diamondDust","burst":"softDiamondGlow","motion":"still","accent":"#ead9aa","size":52,"follow":0.48,"emitDistance":18,"clickOn":"down","burstParticles":3,"hotspot":[0.25,0.56],"primary":"#9d2733","secondary":"#ead9aa"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
