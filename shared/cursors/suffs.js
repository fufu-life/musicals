...
(() => {
  ...
  const config = {"motif":"voteButton","trail":"magicDust","burst":"crispShockwave","motion":"still","accent":"#e3ba25","size":58,"follow":0.46,"emitDistance":16,"clickOn":"up","burstParticles":4,"hotspot":[0.5,0.5],"primary":"#f0c62b","secondary":"#7e4fa1"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
