(() => {
  ...
  const config = {"motif":"littlePrinceScarf","trail":"b612Stars","burst":"planetOrbit","motion":"still","accent":"#e3bd58","size":54,"follow":0.48,"emitDistance":18,"clickOn":"down","burstParticles":3,"hotspot":[0.5,0.5],"primary":"#e3bd58","secondary":"#9ecbe8"};
  const particles = [];
  const bursts = [];
  const trailPoints = [];
