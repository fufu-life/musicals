const SETTINGS_KEY = "elisabeth-das-musical-display-settings";
const CURRENT_SONG_KEY = "elisabeth-das-musical-current-song";
const SIDEBAR_KEY = "elisabeth-das-musical-sidebar-collapsed";
