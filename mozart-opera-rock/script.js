const SETTINGS_KEY = "mozart-opera-rock-display-settings";
const CURRENT_SONG_KEY = "mozart-opera-rock-current-song";
const SIDEBAR_KEY = "mozart-opera-rock-sidebar-collapsed";
const PLAYBACK_RATE_KEY = "mozart-opera-rock-playback-rate";
